...
public class Article implements Serializable{
	...
	public Article(Integer id, String title, String picture, Integer channelId, Integer categoryId, String channelName,
			String categoryName, Integer userId, String nickname, Integer hits, Integer hot, Integer status,
			Integer deleted, String created, Date updated, int commentcnt, String content, String statusIds,
			int tousuCnt, String username) {
		super();
		this.id = id;
		this.title = title;
